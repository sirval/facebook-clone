                ...
                posts.forEach(post => {
                    ...
                    let postView = `
                        <div class="post-header d-flex justify-content-between align-items-center mb-4">
                            <div class="image">
                                <a href="${userProfileRoute}/${post.user.id}"><img src="${post.user.profile_pic ? post.user.profile_pic : `${baseURL}/assets/images/user/user-default.png`}" class="rounded-circle" alt="image"></a>
                            </div>
                            <div class="info ms-3">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <a class="dropdown-item d-flex align-items-center post-delete-button" data-bs-toggle="modal" data-post-id="${post.id}" data-post-content="${post.content}" href="#deletePostModal">
                                            <i class="flaticon-edit"></i> Delete Post
                                        </a>
                                    </li>
                                </ul>
                            </div>` : ''}
                        ...
                        <div class="post-comment-list" id="post-comment-list-${post.id}">
                            <div class="comment-list" style="display:none">
                                <div class="comment-image">
                                    <a href="${userProfileRoute}/${comment.user.id}"><img src="${comment.user.profile_pic ? comment.user.profile_pic : `${baseURL}/assets/images/user/user-default.png`}" class="rounded-circle" alt="${comment.user.name +'image'}"></a>
                                </div>
                                <div class="comment-info">
                                   ...
                                   <!--- <ul class="comment-react">
                                        <li><span style="cursor: pointer" class="like">Like(#)</span></li>
                                        <li><span style="cursor: pointer" class="reply">Reply(#)</span></li>
                                    </ul> ----!>
                                </div>
                            </div> 
                            ...
                            <form id="commentForm-${post.id}" class="post-footer" style="display:none">
                                <div class="footer-image">
                                    <a href="#"><img src="${post.user.profile_pic ? post.user.profile_pic : `${baseURL}/assets/images/user/user-default.png`}" class="rounded-circle" alt="image"></a>
                                </div>
                        ...
                        if (post.notifications.length > 0) {
                                ...
                                const notificationView = `
                                    <div class="item d-flex justify-content-between align-items-center">
                                        <div class="figure">
                                            <a href="#"><img src="${notification.user.profile_pic ? notification.user.profile_pic : `${baseURL}/assets/images/user/user-default.png`}" class="rounded-circle" alt="image"></a>
                                        </div>
                                        <div class="text">
